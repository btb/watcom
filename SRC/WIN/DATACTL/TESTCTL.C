 ...
 * TESTCTL.C
 *
 * Data Control windows program; demonstrates the use of the Data Control
 * library. This library allows completely data driven dialogs to be
 * developed. See 'read.me' for more information.
 *
 */
#include <stdio.h>
#include <windows.h>
